 ...
 */
public interface JdbiContributionHandler {
    ...
    <R> R withJdbi(String dataSourceName, Closure<R> closure);

    <R> R withJdbi(CallableWithArgs<R> callable);

    <R> R withJdbi(String dataSourceName, CallableWithArgs<R> callable);
}